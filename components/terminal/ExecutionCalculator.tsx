...
/**
 * Execution calculator (Priority 4). A "pair" is one share on each leg, which
 * guarantees a \$1 payout. Given a target capital, we deploy whole-dollar
 * fractional pairs and show allocation, guaranteed (worst-case) net profit, and
 * net ROI — all live as the stake changes.
 */
export function ExecutionCalculator({ opportunity }: { opportunity: Opportunity }) {
